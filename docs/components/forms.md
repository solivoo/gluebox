...
`displayMode`: `date`, `datetime`, `time` (según implementación del componente).
...
Valor: `{ start: Date | null, end: Date | null }`.
...
Los presets están exportados: `textBoxThemes`, `selectThemes`, `dateBoxThemes`, `rangeDateBoxThemes`.
