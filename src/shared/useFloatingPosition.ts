...
export interface FloatingCoords {
  ...
  left: number;
  maxHeight?: number;
  /** Ancho del trigger; útil para menús que no deben ser más estrechos. */
  minWidth: number;
}
...
export function computeFloatingPosition(
  ...
  return { top, left, maxHeight, minWidth: triggerRect.width };
}

/** Posiciona un overlay `position: fixed` respecto al trigger; recalcula en scroll/resize. */
