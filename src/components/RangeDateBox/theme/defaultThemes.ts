import type { RangeDateBoxTheme, RangeDateBoxThemePreset } from './RangeDateBox.theme.types';

export const rangeDateBoxThemes: Record<RangeDateBoxThemePreset, RangeDateBoxTheme> = {
  dark: {
    fontSize: '0.875rem',
    borderRadius: '0.5rem',
